...
echo ""
echo "--- Rewind / Recap ---"
echo "  INFO  claude: /rewind is an internal slash command (verified via official docs — code.claude.com/docs/en/commands)"
echo "  INFO  claude: /recap is an internal slash command (verified via official docs — code.claude.com/docs/en/commands)"
echo "  INFO  gemini: /rewind is an internal slash command (verified from source — rewindCommand.tsx)"
...
echo "  INFO  claude: CLAUDE_CODE_DISABLE_FAST_MODE (verified at code.claude.com/docs/en/env-vars)"
...
echo "  INFO  claude: /usage is primary cost command (verified via official docs — /cost and /stats are aliases)"
echo "  INFO  claude: /goal is an internal slash command (verified via official docs — code.claude.com/docs/en/commands)"
echo "  INFO  claude: /fast is an internal slash command (verified via official docs — code.claude.com/docs/en/commands)"
echo "  INFO  claude: opusplan model alias (verified at code.claude.com/docs/en/model-config)"
echo "  INFO  codex: /goal is an internal slash command (verified from source and OpenAI blog)"
echo "  INFO  codex: /side is an internal slash command (verified from developer docs)"
echo "  INFO  codex: service_tier flex (verified from codex config reference)"
