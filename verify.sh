...
echo ""
echo "--- Prompt Cache ---"
# CC: 10% of input, 1-hour TTL on subs, 5-min on API keys — verified from code.claude.com/docs/en/prompt-caching
echo "  INFO  claude: prompt cache 10% / 1-hour TTL on subs, 5-min on API keys (verified from code.claude.com/docs/en/prompt-caching)"
echo "  INFO  claude: ENABLE_PROMPT_CACHING_1H=1 env var (verified from code.claude.com/docs/en/prompt-caching)"
...
echo "  INFO  claude: CLAUDE_CODE_MAX_CONCURRENT_SUBAGENTS (verified at code.claude.com/docs/en/sub-agents)"
echo "  INFO  claude: ENABLE_TOOL_SEARCH (verified at code.claude.com/docs/en/mcp)"
...
echo "  INFO  gemini: /stats and /stats tools are internal slash commands (verified from source)"
...
echo ""
echo "--- New Slash Commands (Aug 2026) ---"
...
echo "  INFO  claude: /recap is an internal slash command (verified via official docs)"
echo "  INFO  cursor: /side and /btw are interactive slash commands (verified in cursor.com/changelog/3-11)"
echo "  INFO  cursor: /multitask is an interactive slash command (verified in cursor.com/changelog)"
echo "  INFO  cursor: /model auto is an interactive slash command (verified in cursor.com/changelog/router)"
...
echo "  INFO  codex: /init is an internal slash command (verified from source)"
echo "  INFO  codex: /agents is an internal slash command (verified from source)"
...
echo "  INFO  gemini: /chat save is an internal slash command (verified from source)"
echo "  INFO  gemini: /rewind is an internal slash command (verified from source)"
echo "  INFO  gemini: /stats tools is an internal slash command (verified from source)"
echo "  INFO  gemini: /agents config is an internal slash command (verified from source)"
