...
echo "  INFO  claude: /usage replaces /cost (verified via official docs)"
...
echo "  INFO  gemini: Antigravity CLI transition June 18 2026 (verified from Google Developers Blog)"
