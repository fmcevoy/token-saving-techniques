...
echo "  INFO  claude: CLAUDE_CODE_EFFORT_LEVEL (verified at code.claude.com/docs/en/model-config)"
...
echo ""
echo "--- New Commands (April 2026) ---"
echo "  INFO  claude: /rewind (/checkpoint, /undo) (verified via official docs)"
echo "  INFO  claude: /usage (verified via official docs)"
...
echo "  INFO  cursor: /btw (verified via cursor.com/changelog/04-14-26)"
echo "  INFO  cursor: /summarize (verified via cursor.com/changelog)"
echo "  INFO  cursor: /statusline (verified via cursor.com/changelog/04-14-26)"
echo "  INFO  codex: /side (verified from source — slash_command.rs)"
echo "  INFO  codex: /fast (verified from source — slash_command.rs)"
echo "  INFO  codex: /memories (verified from source — slash_command.rs)"
echo "  INFO  gemini: /rewind (verified from source — v0.27.0)"
echo "  INFO  gemini: /hooks (verified from source — hooks/index.md)"
echo "  INFO  gemini: /stats tools (verified from source — v0.38.0)"
