...
echo ""
echo "--- Prompt Cache ---"
# CC: 10% of input (Fable 5.1: 2.5%), 1h TTL subscription / 5-min API key
echo "  INFO  claude: prompt cache 10% (Fable 2.5%) / 1h subscription TTL (verified from Anthropic pricing & CC docs)"
...
echo "  INFO  claude: /effort is an internal slash command — low/med/high/xhigh/max (verified via official docs)"
echo "  INFO  cursor: /max-mode is an interactive slash command (verified in agent CLI)"
echo "  INFO  codex: /model (set effort) — 6 levels none→max + ultra (verified from source)"
echo "  INFO  gemini: /model set is an internal slash command (verified from source)"

echo ""
echo "--- Fast Mode ---"
echo "  INFO  claude: /fast toggles high-speed Opus at \$10/\$50 MTok (verified at code.claude.com/docs/en/fast-mode)"
...
echo "--- Context Window & Thinking Budget ---"
...
echo "  INFO  claude: bashOutputMaxChars setting (verified in CC changelog v2.1.261)"
echo "  INFO  claude: /autocompact slash command (verified at code.claude.com/docs/en/commands)"
echo "  INFO  codex: rollout_token_budget in config.toml (verified from openai/codex source)"
...
echo "  INFO  claude: /fast is an internal slash command (verified at code.claude.com/docs/en/fast-mode)"
echo "  INFO  claude: /autocompact is an internal slash command (verified at code.claude.com/docs/en/commands)"
echo "  INFO  claude: /skill-doctor is an internal slash command (verified in CC changelog v2.1.261)"
echo "  INFO  cursor: /btw and /side (verified via cursor.com/changelog/side-chat July 2026)"
echo "  INFO  cursor: /context (verified via cursor.com/changelog/05-06-26)"
echo "  INFO  cursor: /rewind (verified via cursor.com/changelog June 2026)"
echo "  INFO  cursor: /mcp is an interactive slash command (verified in agent CLI)"
echo "  INFO  codex: /usage is an internal slash command (verified from source v0.142.0)"
echo "  INFO  codex: /goal is an internal slash command (verified from source v0.128.0)"
echo "  INFO  codex: /recap is an internal slash command (verified from source v0.153.0)"
...
echo "  INFO  gemini: /rewind (verified from github.com/google-gemini/gemini-cli PR #15720)"
