...
check claude "CC --effort includes xhigh" "command claude --help" "xhigh"
...
echo "  INFO  claude: /cd is an internal slash command (verified at code.claude.com/docs/en/whats-new/2026-w24)"
echo "  INFO  claude: /usage-credits is an internal slash command (verified at code.claude.com/docs/en/costs)"
echo "  INFO  claude: /config key=value is an internal slash command (verified at code.claude.com/docs/en/changelog)"
echo "  INFO  claude: /reload-skills is an internal slash command (verified at code.claude.com/docs/en/whats-new/2026-w22)"
...
echo "  INFO  cursor: /automate is an interactive slash command (verified at cursor.com/changelog/06-18-26)"
echo "  INFO  codex: /goal is an internal slash command (verified from GitHub releases v0.128.0)"
echo "  INFO  codex: /usage is an internal slash command (verified from GitHub releases v0.140.0)"
echo "  INFO  codex: /permissions is an internal slash command (verified from GitHub releases v0.135.0)"
echo "  INFO  gemini: /model set is an internal slash command (verified from source)"
echo "  INFO  gemini: /rewind is an internal slash command (verified from github.com/google-gemini/gemini-cli PR #15720)"
echo "  INFO  gemini: /commands is an internal slash command (verified from github.com/google-gemini/gemini-cli docs)"
...
echo "  INFO  claude: CLAUDE_CODE_DISABLE_BUNDLED_SKILLS (verified at code.claude.com/docs/en/whats-new/2026-w24)"
echo "  INFO  claude: CLAUDE_CODE_DISABLE_FAST_MODE (verified at code.claude.com/docs/en/fast-mode)"
