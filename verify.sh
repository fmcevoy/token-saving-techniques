...
echo ""
echo "--- New Features (Sep 2026 update) ---"
...
echo "  INFO  claude: promptCacheTtl setting (verified at code.claude.com/docs/en/settings)"
echo "  INFO  claude: subagentPromptCacheTtl setting (verified at code.claude.com/docs/en/settings)"
...
echo "  INFO  codex: model_auto_compact_token_limit config (verified from source)"
echo "  INFO  codex: tool_output_token_limit config (verified from source)"
echo "  INFO  codex: default_subagent_model config (verified from source)"
echo "  INFO  codex: project_doc_max_bytes config (verified from source)"
echo "  INFO  codex: 12 hook events (verified from source — protocol/v2/hook.rs)"
echo "  INFO  codex: GPT-6-Astra model (verified from source — daybreak.rs)"
echo "  INFO  gemini: /rewind is an internal slash command (verified from source)"
echo "  INFO  gemini: /skills list|link|disable|enable|reload (verified from source)"
echo "  INFO  gemini: /memory inbox (verified from source)"
echo "  INFO  gemini: model.compressionThreshold setting (verified from source)"
echo "  INFO  gemini: truncateToolOutputThreshold setting (verified from source)"
echo "  INFO  gemini: billing.overageStrategy setting (verified from source)"
echo "  INFO  gemini: general.plan.modelRouting setting (verified from source)"

echo ""
echo "--- Quick Ref Slash Commands ---"
echo "  INFO  claude: /context is an internal slash command (verified via official docs)"
echo "  INFO  codex: /btw is an internal slash command (verified from source)"
echo "  INFO  codex: /recap is an internal slash command (verified from source)"
echo "  INFO  codex: /new is an internal slash command (verified from source)"
echo "  INFO  gemini: /rewind is an internal slash command (verified from source)"
