...
echo ""
echo "--- Prompt Cache ---"
# CC: 10% of input, configurable TTL (5m default, up to 1h) — verified from CC changelog v2.1.243
echo "  INFO  claude: prompt cache 10% / configurable TTL 5m-1h (verified from CC changelog v2.1.243)"
echo "  INFO  claude: promptCacheTtl and subagentPromptCacheTtl settings (verified from CC changelog)"
echo "  INFO  gemini: auto token caching for API key / Vertex users (verified from gemini-cli docs/cli/token-caching.md)"
...
echo "  INFO  claude: CLAUDE_CODE_SUBAGENT_MODEL (verified from CC changelog v2.1.257)"
echo "  INFO  claude: CLAUDE_AUTO_BACKGROUND_TASKS (verified at code.claude.com/docs/en/env-vars)"
echo "  INFO  gemini: model.compressionThreshold default 0.5 (verified from gemini-cli docs/reference/configuration.md)"
echo "  INFO  gemini: model.maxSessionTurns (verified from gemini-cli docs/reference/configuration.md)"
echo "  INFO  gemini: tools.truncateToolOutputThreshold default 40000 (verified from gemini-cli docs/reference/configuration.md)"
...
echo "  INFO  claude: /usage is an internal slash command (verified from CC changelog)"
echo "  INFO  claude: /skill-doctor is an internal slash command (verified from CC changelog v2.1.261)"
...
echo "  INFO  cursor: /side is an interactive slash command (verified in cursor CLI changelog v3.11)"

echo ""
echo "--- Gemini Tool Output Management ---"
echo "  INFO  gemini: contextManagement.tools.outputMasking (verified from gemini-cli docs/reference/configuration.md)"
echo "  INFO  gemini: contextManagement.tools.distillation (verified from gemini-cli docs/reference/configuration.md)"
echo "  INFO  gemini: general.plan.modelRouting auto Pro/Flash (verified from gemini-cli docs/reference/configuration.md)"

echo ""
echo "--- Codex MCP Output Limit ---"
echo "  INFO  codex: MCP output_token_limit per-tool setting (verified from codex release v0.152.0)"
