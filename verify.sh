...
echo ""
echo "--- Prompt Cache ---"
echo "  INFO  claude: prompt cache reads 10% of input (verified at platform.claude.com/docs/en/about-claude/pricing)"
echo "  INFO  claude: cache writes 1.25x (5-min) / 2x (1-hr) (verified at platform.claude.com/docs/en/about-claude/pricing)"
echo "  INFO  claude: ENABLE_PROMPT_CACHING_1H (verified at code.claude.com/docs/en/prompt-caching)"
echo "  INFO  claude: FORCE_PROMPT_CACHING_5M (verified at code.claude.com/docs/en/prompt-caching)"
echo "  INFO  claude: subagents use 5-min TTL (verified at code.claude.com/docs/en/prompt-caching)"
echo "  INFO  gemini: token caching API key only (verified at github.com/google-gemini/gemini-cli docs/cli/token-caching.md)"
...
echo "  INFO  claude: /fork copies conversation to background session (verified via official docs)"
echo "  INFO  claude: /subtask spawns subagent (verified via official docs)"
echo "  INFO  cursor: built-in subagents (no CLI flag to test)"
echo "  INFO  codex: /agent and /fork are internal slash commands (verified from source)"
echo "  INFO  gemini: /agents is an internal slash command (verified from source)"
echo "  INFO  gemini: custom agents via .gemini/agents/*.md (verified from source docs/core/subagents.md)"
...
echo "  INFO  claude: MAX_THINKING_TOKENS (verified at code.claude.com/docs/en/model-config)"
