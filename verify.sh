...
echo "  INFO  claude: CLAUDE_CODE_MAX_TURNS (verified at code.claude.com/docs/en/env-vars)"
...
echo "  INFO  claude: Opus 4.7 is current flagship (verified at platform.claude.com/docs/en/about-claude/models)"
echo "  INFO  claude: /fast mode \$30/\$150 MTok (verified at code.claude.com/docs/en/fast-mode)"
...
echo "  INFO  claude: /usage is an internal slash command (verified via official docs — aliases /cost, /stats)"
...
echo "  INFO  claude: /agents is an internal slash command (verified via official docs)"
...
echo "  INFO  codex: /fast is an internal slash command (verified from developers.openai.com/codex)"
echo "  INFO  codex: /goal is an internal slash command (verified from developers.openai.com/codex)"
echo "  INFO  codex: /permissions is an internal slash command (verified from developers.openai.com/codex)"
...
echo "  INFO  gemini: /commands is an internal slash command (verified from source)"
echo "  INFO  cursor: /mcp is an interactive slash command (verified in agent CLI)"
echo "  INFO  cursor: /multitask is an interactive slash command (verified from cursor.com/changelog)"
echo "  INFO  cursor: /rules is an interactive slash command (verified from cursor.com/changelog)"
